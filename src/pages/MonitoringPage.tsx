                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          ...
                          <span className="text-sm text-green-600 dark:text-green-400 font-medium">Live Updates</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {isLoading ? (
                <div className="flex justify-center items-center py-20">
                  <div className="text-center space-y-6">
                    ...
                    <div>
                      <p className="text-xl font-semibold text-gray-600 dark:text-gray-400 animate-pulse">Loading dashboard...</p>
                ...
                <>
                  {/* KPI Summary Cards */}
                  <KPISummary users={safeUsers} />

                  {/* Enhanced Filters */}
                  <EnhancedFilters onFiltersChange={handleFiltersChange} />

                  {/* Activity Timeline */}
                  <ActivityTimeline users={safeUsers} />
                  ...
                  <Card className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-gray-200/50 dark:border-gray-700/50 shadow-2xl hover:shadow-3xl transition-all duration-300 animate-fade-in" style={{ animationDelay: '400ms' }}>
                    <CardHeader className="pb-6 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/50 dark:via-indigo-950/50 dark:to-purple-950/50 rounded-t-lg border-b border-gray-200/30 dark:border-gray-700/30">
                      <div className="flex items-center justify-between">
                        <div className="space-y-2">
                          <CardTitle className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 dark:from-white dark:via-blue-200 dark:to-indigo-200 bg-clip-text text-transparent">
                            Team Activity
                          </CardTitle>
